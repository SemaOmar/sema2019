...
#define _nstates8	11	/* spec5 */
#define minseq8	126
#define maxseq8	135
#define _endstate8	10

#define _nstates7	11	/* spec4 */
#define minseq7	116
#define maxseq7	125
#define _endstate7	10

#define _nstates6	11	/* spec3 */
#define minseq6	106
#define maxseq6	115
#define _endstate6	10

#define _nstates5	11	/* spec2 */
#define minseq5	96
#define maxseq5	105
#define _endstate5	10

#define _nstates4	11	/* spec1 */
#define minseq4	86
#define maxseq4	95
#define _endstate4	10

#define _nstates3	17	/* actions */
#define minseq3	70
#define maxseq3	85
#define _endstate3	16

#define _nstates2	7	/* fsm_alarma */
#define minseq2	64
#define maxseq2	69
#define _endstate2	6
...
#define _nstates0	60	/* codigo */
#define minseq0	0
#define maxseq0	58
#define _endstate0	59
...
#define Pfsm_alarma	((P2 *)_this)
typedef struct P2 { /* fsm_alarma */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pcodigo	((P0 *)_this)
typedef struct P0 { /* codigo */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
