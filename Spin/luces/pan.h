...
#define _nstates4	14	/* spec1 */
#define minseq4	58
#define maxseq4	70
#define _endstate4	13

#define _nstates3	16	/* actions */
#define minseq3	43
#define maxseq3	57
...
#define _nstates1	7	/* fsm_alarma */
#define minseq1	30
#define maxseq1	35
#define _endstate1	6

#define _nstates0	31	/* fsm_luz */
#define minseq0	0
#define maxseq0	29
...
#define Pfsm_alarma	((P1 *)_this)
typedef struct P1 { /* fsm_alarma */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_luz	((P0 *)_this)
typedef struct P0 { /* fsm_luz */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
/* hidden variable: */	uchar codigo_ok;
